	...
	<div class="container-fluid display-table">
		<div class="row display-table-row">
			<div
				...
				id="navigation">
				<div class="logo">
					<a hef="home.html"><img src="images/clockinout.png" alt="logo"
				...
				<div class="navi" style="height: 1000px;">
					<ul>
						...
						<li><a href="./AttendenceController?empId=${employee.empId}"><i class="fa fa-tasks" aria-hidden="true"></i><span
								class="hidden-xs hidden-sm">Attendence Detais</span></a></li>
						...
						<li><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span
								class="hidden-xs hidden-sm">View Profile</span></a></li>
						<li><a href="#"><i class="fa fa-calendar"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm">View</span></a></li>
						<li><a href="#"><i class="fa fa-edit" aria-hidden="true"></i><span
								class="hidden-xs hidden-sm">Edit Profile</span></a></li>
					</ul>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="header-rightside">
							<ul class="list-inline header-top" style="margin-left: 87px;">
								...
								<li><span>${employee.firstName}</span></li>
					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<input name="fname" type="text" placeholder="Enter First Name Here.." class="form-control" value=${employee.firstName}>
							</div>
							<div class="col-sm-6 form-group">
								<label>Last Name</label>
								<input name="lname" type="text" placeholder="Enter Last Name Here.." class="form-control" value=${employee.lastName}>
							</div>
						</div>					
						...
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								<label>EmpId</label>
								<input name="empId" type="text" placeholder="Enter Employee Id Here.." class="form-control" value=${employee.empId}>
							</div>	
						</div>	
						<div class="row">					
					<div class="col-sm-6 form-group">
						<label>Phone Number</label>
						<input name="contactNo" type="text" placeholder="Enter Phone Number Here.." class="form-control" value=${employee.contactNo}>
					</div>		
					<div class="col-sm-6 form-group">
						<label>Email Address</label>
						<input  name="email" type="text" placeholder="Enter Email Address Here.." class="form-control" value=${employee.email}>
					</div>	
					</div>
					<div class="row">
							<div class="col-sm-6 form-group">
						...
						<div class="col-sm-6 form-group">
								...
								<c:choose>
								<c:when test="${employee.gender.equals('M')}">
								<div class="radio">
